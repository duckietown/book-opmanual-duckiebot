...
<div style="padding:56.25% 0 0 0;position:relative;">
    <iframe src="https://player.vimeo.com/video/527006910" 
        style="position:absolute;top:0;left:0;width:100%;height:100%;" 
       allow="autoplay; fullscreen; picture-in-picture" allowfullscreen>
    </iframe></div><script src="https://player.vimeo.com/api/player.js"></script>

<p><a href="https://vimeo.com/527006910">Docker basics</a> 
    from <a href="https://vimeo.com/duckietown">Duckietown</a> on
...
```{list-table} Different types of virtualization
:header-rows: 1
* - Using containers
  - Using VMs
* - ![](../../_images/preliminary_software/docker_basics/docker-containerVM.png)
  - ![](../../_images/preliminary_software/docker_basics/docker-containerVM2.png)
```
